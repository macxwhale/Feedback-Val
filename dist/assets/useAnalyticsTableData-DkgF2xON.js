import{u as H,s as y}from"./index-fQWeZZOi.js";const O=u=>H({queryKey:["analytics-table-data",u],queryFn:async()=>{const{data:x,error:w}=await y.from("questions").select(`
          id,
          question_text,
          question_type,
          category,
