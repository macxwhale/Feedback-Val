import{u as K,s as E}from"./index-rH_t7hfM.js";const j=p=>K({queryKey:["analytics-table-data",p],queryFn:async()=>{console.log("Fetching analytics data for organization:",p);const{data:m,error:y}=await E.from("questions").select(`
          id,
          question_text,
          question_type,
          category,
