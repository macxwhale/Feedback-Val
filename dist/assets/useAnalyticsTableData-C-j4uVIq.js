import{a3 as M,a4 as p}from"./index-CI5pWOu5.js";const S=l=>M({queryKey:["analytics-table-data",l],queryFn:async()=>{const{data:f,error:u}=await p.from("questions").select(`
          id,
          question_text,
          question_type,
          category,
