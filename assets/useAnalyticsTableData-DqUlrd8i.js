import{a3 as H,a4 as y}from"./index-B57QPpVD.js";const O=u=>H({queryKey:["analytics-table-data",u],queryFn:async()=>{const{data:x,error:w}=await y.from("questions").select(`
          id,
          question_text,
          question_type,
          category,
