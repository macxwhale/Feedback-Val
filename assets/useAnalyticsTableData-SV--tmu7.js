import{u as M,s as p}from"./index-CMMZzhnG.js";const S=l=>M({queryKey:["analytics-table-data",l],queryFn:async()=>{const{data:f,error:u}=await p.from("questions").select(`
          id,
          question_text,
          question_type,
          category,
