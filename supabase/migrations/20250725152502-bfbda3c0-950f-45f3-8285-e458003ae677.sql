...
-- Critical Security Fix 1: Enable RLS on organization_users table
ALTER TABLE public.organization_users ENABLE ROW LEVEL SECURITY;

-- Critical Security Fix 2: Add search_path to database functions to prevent schema poisoning
...
-- Create security monitoring table for tracking security events
...
BEGIN
  INSERT INTO public.security_events (
    event_type, user_id, organization_id, ip_address, user_agent, event_data, severity
  ) VALUES (
    p_event_type, p_user_id, p_organization_id, p_ip_address, p_user_agent, p_event_data, p_severity
